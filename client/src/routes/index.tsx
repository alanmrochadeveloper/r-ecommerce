        ...
        <Route  path ="/test" component={TestApi} />
				...
				<Route path="/dashboard" render={
					({ match: { path } }) => (<DashboardCustomerWrapper>
							<Switch>
								<Route exact path={`${path}/inicio`} component={DashboardCustomerHome} />
								<Route exact path={`${path}/configuracoes`} component={DashboardCustomerSettings} />
								<Route exact path={`${path}/compras`} component={DashboardCustomerPurchases} />
								<Route exact path={`${path}/acompanhamento`} component={DashboardCustomerFollowUp} />
								<Route path={`${path}/404`} component={NotFound} />
                <Redirect from={`${path}/*`} to={`${path}/404`}/>
							</Switch>	
